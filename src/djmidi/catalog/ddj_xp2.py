...
_STATIC: list[ControlInfo] = [
    ...
    # The second physical click is emitted as a distinct NOTE (27->28,
    # 30->31, 32->33, 34->35), not as a repeated first click.
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 5", "NOTE", _DECK_CH, "28"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 5 (+SHIFT)", "NOTE", _DECK_CH, "106"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 6", "NOTE", _DECK_CH, "31"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 6 (+SHIFT)", "NOTE", _DECK_CH, "108"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 7", "NOTE", _DECK_CH, "33"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 7 (+SHIFT)", "NOTE", _DECK_CH, "110"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 8", "NOTE", _DECK_CH, "35"),
    ControlInfo("DDJ-XP2", "PAD MODE", "PAD MODE 8 (+SHIFT)", "NOTE", _DECK_CH, "112"),
...
register(
    ControllerDefinition(
        ...
        reference_image="ddj-xp2/reference.png",
        display_order=10,
